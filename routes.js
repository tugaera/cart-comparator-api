...
// This section will help you get a list of all the records.
recordRoutes.route("/assets").get(async function (req, res) {
    // Get records
    const dbConnect = dbo.getDb();
...
/**
 * PLACE LOCATED ASSETS
 */

// This section will help you get a list of all the records.
recordRoutes.route("/places").get(async function (req, res) {
    // Get records
    const dbConnect = dbo.getDb();
...
/**
 * PERSON OWN PLACE/ASSET
 */

// This section will help you get a list of all the records.
recordRoutes.route("/persons").get(async function (req, res) {
    // Get records
    const dbConnect = dbo.getDb();
